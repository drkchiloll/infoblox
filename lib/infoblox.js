...
infoblox.prototype.login = function(user, pwd) {
  ...
  return client._req('grid', {
    ...
    // client.grid = JSON.parse(res)[0]._ref;
...
infoblox.prototype.getNetwork = function(subnet) {
  var client = this;
  return client._req('network?network=' + subnet, {
    method : 'GET'
  });
};
...
infoblox.prototype.getIpsFromSubnet = function(subnet) {
  return this._req('ipv4address?network='+ subnet, {
    method : 'GET'
  });
}

infoblox.prototype.getNetworksFromContainer = function(container) {
  return this._req('network?network_container='+ container, {
    method : 'GET'
  });
};
...
/**
  Add Permission Object (json)
  {
    group : adminGroup,
    permission : 'READ | WRITE | DENY',
    object : 'REFERENCE ID OF CONTAINER/NETWORK/ETC'
  }
 */
